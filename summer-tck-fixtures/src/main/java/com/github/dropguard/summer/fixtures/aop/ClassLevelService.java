 ...
 *
 * <p>Unlike {@link GreeterService} where only {@code greet()} is annotated, here the entire class
 * is annotated. This verifies that the AOP engine detects class-level interceptor bindings and
 * proxies ALL methods.
 */
@Component
@Logged
