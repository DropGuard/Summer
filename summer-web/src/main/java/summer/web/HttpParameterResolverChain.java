 ...
 *
 * <p>
 * Manages the built-in parameter resolvers as framework infrastructure, ordered
 * by the list passed to the constructor. If no resolver supports a parameter,
 * the chain falls back to {@code ctx.body(param.type())}.
 * </p>
 */
