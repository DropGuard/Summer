 ...
 *
 * <p>
 * Separates body parsing and validation concerns from {@link HttpContext}. The
 * {@link BodyConverter} handles serialization format (JSON, etc.) and the
 * {@link Validator} handles constraint validation.
 * </p>
 */
