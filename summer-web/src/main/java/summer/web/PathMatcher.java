 ...
 *
 * <p>
 * Provides static methods to compile path patterns (with {@code {param}},
 * {@code *}, {@code **} wildcards) into regex-based {@link RouteEntry}s and to
 * match concrete paths against them.
 * </p>
 */
public final class PathMatcher {
	 ...
	 * Supported patterns:
	 * <ul>
	 * <li>{@code {name}} - captures a path segment as parameter "name"</li>
	 * <li>{@code *} - matches exactly one path segment</li>
	 * <li>{@code **} - matches zero or more path segments (must be last)</li>
	 * </ul>
	 *
	 * @param path
	 *            the path pattern to compile
	 ...
	 *
	 * @param entry
	 *            the compiled route entry
	 * @param path
	 *            the concrete path to match
