...
/**
 * Represents sorting parameters for queries. Follows the Spring Data JPA Sort interface design.
 *
 * <p>Usage:
 *
 * <pre>
...
public record Sort(List<Order> orders) {
    ...
    /**
     * Parses a sort string in the format "property,direction". Example: "createdAt,desc" or
     * "createdAt,asc"
     *
     * @param sortString the sort string to parse
     * @return a new Sort instance
     */
