 ...
 *
 * <p>
 * This is a framework infrastructure bean managed by
 * {@code RouterConfiguration}. Router implementations register their factories
 * via the {@link #registerHttp} and {@link #registerWs} methods.
 * </p>
 *
 * <p>
 * The registry is injected into {@link HttpRouter.Builder} and
 * {@link WsRouter.Builder} to create routers based on {@link RouterType}.
 * </p>
 *
 * @see RouterType
 */
public final class RouterRegistry {
	...
	private final Map<RouterType, Function<List<HttpRouter.Builder.Route>, HttpRouter>> httpFactories = new EnumMap<>(
			RouterType.class);
	private final Map<RouterType, Function<List<WsRouter.WsRoute>, WsRouter>> wsFactories = new EnumMap<>(
			RouterType.class);
	 ...
	 */
	public void registerHttp(RouterType type, Function<List<HttpRouter.Builder.Route>, HttpRouter> factory) {
	...
	public Function<List<HttpRouter.Builder.Route>, HttpRouter> httpFactory(RouterType type) {
		...
		if (factory == null) {
			throw new IllegalArgumentException("No HTTP router factory registered for type: " + type);
		}
		return factory;
	}
	...
	public Function<List<WsRouter.WsRoute>, WsRouter> wsFactory(RouterType type) {
		...
		if (factory == null) {
			throw new IllegalArgumentException("No WebSocket router factory registered for type: " + type);
		}
		return factory;
	}
}
