...
/**
 * Stateless utility methods for reading annotation values from {@link Element}s.
 * All methods are static — they receive {@link ProcessingEnvironment} as a parameter.
 */
final class AnnotationHelper {
    ...
    static List<TypeMirror> getAnnotationClassListValue(Element element, String annotationFqn, ProcessingEnvironment processingEnv) {
    ...
    static List<String> getAnnotationStringArrayValue(AnnotationMirror am, String paramName, ProcessingEnvironment processingEnv) {
