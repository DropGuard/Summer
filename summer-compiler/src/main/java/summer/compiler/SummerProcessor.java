...
public class SummerProcessor extends AbstractProcessor {
    ...
    private void discoverFrameworkBeans() {
        // Read META-INF/summer-beans.txt from classpath JARs (auto-generated by other modules)
        try {
            ClassLoader cl = this.getClass().getClassLoader();
            java.util.Enumeration<java.net.URL> urls = cl.getResources("META-INF/summer-beans.txt");
            while (urls.hasMoreElements()) {
                ...
                try (java.io.BufferedReader reader = new java.io.BufferedReader(
                    ...
                    while ((line = reader.readLine()) != null) {
                        ...
                        TypeElement te = processingEnv.getElementUtils().getTypeElement(line);
            ...
            processingEnv.getMessager().printMessage(javax.tools.Diagnostic.Kind.WARNING,
                    "Failed to read META-INF/summer-beans.txt: " + e.getMessage());
        }
    }
