...
final class BeanDefinition {
    ...
    /**
     * The type element representing this bean's class.
     * For COMPONENT/CONFIGURATION: the annotated class itself.
     * For FACTORY_PRODUCT: the type element of the return type.
     */
    ...
    /**
     * For FACTORY_PRODUCT beans, the resolved BeanDefinition of the @Configuration class.
     */
