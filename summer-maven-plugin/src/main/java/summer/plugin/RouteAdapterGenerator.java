 ...
 * 
 * <p>In AOT mode, routes are registered statically instead of via reflection.
 * This generator creates a RouteRegistrar that wires up controllers and
 * exception handlers at compile time.</p>
 */
public final class RouteAdapterGenerator {
	...
	public void generate(List<BeanDefinition> beans, java.io.File outputDir) throws IOException {
		...
		TypeSpec routeRegistrar = TypeSpec.classBuilder("GeneratedAnnotationRouterAdapter")
			...
			.addField(ClassName.get("summer.web", "Router"), "router", javax.lang.model.element.Modifier.PRIVATE, javax.lang.model.element.Modifier.FINAL)
			.addField(ClassName.get("summer.core", "ApplicationContext"), "context", javax.lang.model.element.Modifier.PRIVATE, javax.lang.model.element.Modifier.FINAL)
			.addField(ClassName.get("summer.web", "ExceptionRegistry"), "exceptionRegistry", javax.lang.model.element.Modifier.PRIVATE, javax.lang.model.element.Modifier.FINAL)
			...
			.addMethod(MethodSpec.methodBuilder("registerControllers")
				...
				.addModifiers(javax.lang.model.element.Modifier.PUBLIC)
				.addComment("TODO: Register routes statically for AOT mode")
				.build())
			.build();

		JavaFile.builder("summer.core.aot", routeRegistrar)
			.build()
			.writeTo(outputDir);
	}
}
