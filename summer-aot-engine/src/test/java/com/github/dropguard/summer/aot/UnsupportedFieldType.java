 ...
 * each narrow test carries its own fixtures; the data-jdbc side has its own sample in
 * {@code summer-data-jdbc/src/test/.../fixtures/}), so no shared fixtures module is needed and the
