...
public final class LocalContextGenerator {
	 ...
	 * @param outputDir
	 *            directory to write the generated {@code .java} file
	 */
	public void generate(String testClassName, List<BeanDefinition> sortedBeans, IndexView index,
			java.io.File outputDir) throws IOException {
	...
	private MethodSpec buildCreateMethod(List<BeanDefinition> sortedBeans, IndexView index) {
		...
		java.util.Set<String> closureNames = sortedBeans.stream().map(b -> b.qualifiedName)
