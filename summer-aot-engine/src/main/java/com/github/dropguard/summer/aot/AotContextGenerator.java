 ...
 * {@link com.github.dropguard.summer.core.BeanContainer} abstractions.
 *
 * <p>
...
public final class AotContextGenerator {
	...
	private static final ClassName CONFIG_BINDER = ClassName.get("com.github.dropguard.summer.core.config",
			"ConfigBinder");
	private static final ClassName ROUTE_ADAPTER = ClassName.get(PACKAGE, "GeneratedAnnotationRouterAdapter");
	private static final ClassName ROUTE_REGISTRAR = ClassName.get("com.github.dropguard.summer.web", "RouteRegistrar");
	...
	private static final ClassName MOCKED_BEAN = ClassName.get("com.github.dropguard.summer.core.bean", "MockedBean");
