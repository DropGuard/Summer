 ...
 * the runtime engine's exception-handler registrar.
 *
 * <p>
...
public final class ExceptionHandlerAdapterGenerator {
	...
	private static final DotName HTTP_CONTEXT_DOT = DotName.createSimple("com.github.dropguard.summer.web.HttpContext");
	private static final ClassName EXCEPTION_REGISTRY = ClassName.get("com.github.dropguard.summer.web",
			"ExceptionRegistry");
	private static final ClassName BEAN_CONTAINER = ClassName.get("com.github.dropguard.summer.core", "BeanContainer");
	private static final ClassName EXCEPTION_HANDLER_REGISTRAR = ClassName.get("com.github.dropguard.summer.web",
			"ExceptionHandlerRegistrar");
	private static final ClassName REQUEST_ATTRIBUTES = ClassName.get("com.github.dropguard.summer.web",
			"RequestAttributes");
