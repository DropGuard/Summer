 ...
 *
 * <p>
 * This is an <b>internal</b> test fixture: it uses
 * {@code com.github.dropguard.summer.test.internal} directly because it is part
 * of the framework's own integration test module. Demos must NOT copy this —
 * they use the public path (set
 * {@code com.github.dropguard.summer.test.datasource.url} to a real JDBC URL
 * themselves).
 * </p>
 */
@Configuration
public class ItDatabaseConfig {
	...
	public DataSource dataSource() {
		...
		if (url == null) {
			throw new IllegalStateException(
					"Framework IT requires a real database. Call SummerTestLifecycle.ensureDevServices(...) "
							+ "first (it sets com.github.dropguard.summer.test.datasource.url), or set it explicitly.");
		}
		...
		config.setUsername(System.getProperty("com.github.dropguard.summer.test.datasource.username", "test"));
		config.setPassword(System.getProperty("com.github.dropguard.summer.test.datasource.password", "test"));
