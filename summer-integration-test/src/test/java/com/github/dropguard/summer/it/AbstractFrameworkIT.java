 ...
 * depend on {@code com.github.dropguard.summer.test.internal}; they start
 * Testcontainers directly and set
 * {@code com.github.dropguard.summer.test.datasource.url} /
 * {@code com.github.dropguard.summer.redis.uri} themselves (see
 * {@code RedisIntegrationIT}).
 * </p>
 */
abstract class AbstractFrameworkIT {
	...
	static void startEnvironment() throws Exception {
		...
		System.setProperty("com.github.dropguard.summer.test.datasource.url", "summer:devservices:postgres");
