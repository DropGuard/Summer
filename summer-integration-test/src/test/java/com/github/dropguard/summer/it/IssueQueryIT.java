 ...
 *
 * <p>This is the layer H2 cannot validate faithfully: a real JDBC driver's type mapping (here
 * {@code TIMESTAMP} → {@code LocalDateTime}), dialect-correct SQL, and transaction connection
 * sharing under a live database. It runs dual-engine (Runtime + AOT) against the shared
 * dev-services Postgres, exactly like {@link GreetingIT}, so QueryBuilder parity is asserted by the
 * framework.
 */
@SummerTest
