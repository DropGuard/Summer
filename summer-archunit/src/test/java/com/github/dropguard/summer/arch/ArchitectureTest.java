...
class ArchitectureTest {
	...
	private static final String[] PACKAGES = {"com.github.dropguard.summer.core", "com.github.dropguard.summer.web",
			"com.github.dropguard.summer.aop", "com.github.dropguard.summer.tx", "com.github.dropguard.summer.runtime",
			"com.github.dropguard.summer.plugin", "com.github.dropguard.summer.data",
			"com.github.dropguard.summer.boot", "com.github.dropguard.summer.web.netty",
			"com.github.dropguard.summer.grpc", "com.github.dropguard.summer.validation",
			"com.github.dropguard.summer.aot", "com.github.dropguard.summer.test", "com.github.dropguard.summer.tck",
	...
	void layeredArchitecture() {
		...
		Architectures.LayeredArchitecture rule = Architectures.layeredArchitecture()
				...
				// layer definitions
				.layer("Core")         .definedBy("..com.github.dropguard.summer.core..")
				.layer("Infrastructure").definedBy("..com.github.dropguard.summer.runtime..", "..com.github.dropguard.summer.plugin..", "..com.github.dropguard.summer.aot..")
				.layer("Web")          .definedBy("..com.github.dropguard.summer.web..", "..com.github.dropguard.summer.boot..")
				.layer("Data")         .definedBy("..com.github.dropguard.summer.data..")
				.layer("CrossCutting") .definedBy("..com.github.dropguard.summer.aop..", "..com.github.dropguard.summer.tx..", "..com.github.dropguard.summer.validation..")
				.layer("Server")       .definedBy("..com.github.dropguard.summer.web.netty..", "..com.github.dropguard.summer.grpc..")
				.layer("Test")         .definedBy("..com.github.dropguard.summer.test..", "..com.github.dropguard.summer.tck..", "..com.github.dropguard.summer.arch..")
	...
	void noCircularDependencies() {
		ArchRule rule = com.tngtech.archunit.library.dependencies.SlicesRuleDefinition.slices()
				.matching("com.github.dropguard.summer.(*)").should().beFreeOfCycles()
				.ignoreDependency("com.github.dropguard.summer.realworld..", "..")
				.ignoreDependency("com.github.dropguard.summer.benchmark..", "..")
				.ignoreDependency("..", "com.github.dropguard.summer.realworld..")
				.ignoreDependency("..", "com.github.dropguard.summer.benchmark..");
	...
	void aotMustNotDependOnRuntime() {
		...
		// runtime coupling.
		ArchRule rule = noClasses().that().resideInAnyPackage("..com.github.dropguard.summer.aot..").should()
				.dependOnClassesThat().resideInAnyPackage("..com.github.dropguard.summer.runtime..");
		rule.check(classes);
	}
	...
	void runtimeMustNotDependOnAot() {
		...
		ArchRule rule = noClasses().that().resideInAnyPackage("..com.github.dropguard.summer.runtime..").should()
				.dependOnClassesThat().resideInAnyPackage("..com.github.dropguard.summer.aot..");
		rule.check(classes);
	}
	...
	void replacesRequiresConfigurationInFramework() {
		...
		String[] frameworkPackages = {"com.github.dropguard.summer.core..", "com.github.dropguard.summer.web..",
				"com.github.dropguard.summer.aop..", "com.github.dropguard.summer.tx..",
				"com.github.dropguard.summer.runtime..", "com.github.dropguard.summer.plugin..",
				"com.github.dropguard.summer.data..", "com.github.dropguard.summer.boot..",
				"com.github.dropguard.summer.web.netty..", "com.github.dropguard.summer.grpc..",
				"com.github.dropguard.summer.validation.."};

		ArchRule rule = com.tngtech.archunit.lang.syntax.ArchRuleDefinition.classes().that()
				.areAnnotatedWith("com.github.dropguard.summer.core.annotation.Replaces").and()
				.resideInAnyPackage(frameworkPackages).should()
				.beAnnotatedWith("com.github.dropguard.summer.core.annotation.Configuration").allowEmptyShould(true);
		rule.check(classes);
	}
	...
	void frameworkCodeMustUseConfigurationNotComponent() {
		...
		String[] annotationPackages = {"com.github.dropguard.summer.core.annotation..",
		...
		ArchRule rule = com.tngtech.archunit.lang.syntax.ArchRuleDefinition.classes().that()
				...
				.areNotAnnotatedWith("com.github.dropguard.summer.core.annotation.Configuration").should()
				.notBeAnnotatedWith("com.github.dropguard.summer.core.Component").allowEmptyShould(true);
		rule.check(classes);
	}
	...
	void noConcurrentHashMap() {
		String[] productionPackages = {"com.github.dropguard.summer.core..", "com.github.dropguard.summer.web..",
				"com.github.dropguard.summer.aop..", "com.github.dropguard.summer.tx..",
				"com.github.dropguard.summer.runtime..", "com.github.dropguard.summer.plugin..",
				"com.github.dropguard.summer.data..", "com.github.dropguard.summer.boot..",
				"com.github.dropguard.summer.web.netty..", "com.github.dropguard.summer.grpc..",
	...
	void configurationPropertiesRequiresRecord() {
		ArchRule rule = com.tngtech.archunit.lang.syntax.ArchRuleDefinition.classes().that()
				.areAnnotatedWith("com.github.dropguard.summer.core.config.ConfigurationProperties").should()
				.beRecords().allowEmptyShould(true);
		rule.check(classes);
	}
	...
	void rowModelRequiresRecord() {
		ArchRule rule = com.tngtech.archunit.lang.syntax.ArchRuleDefinition.classes().that()
				.areAnnotatedWith("com.github.dropguard.summer.data.jdbc.annotation.RowModel").should().beRecords()
				.allowEmptyShould(true);
		rule.check(classes);
	}
