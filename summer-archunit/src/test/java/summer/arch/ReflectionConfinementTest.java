...
class ReflectionConfinementTest {
	...
	private static final Set<String> CLASS_BANNED = Set.of(
			"getDeclaredMethods", "getMethod", "getMethods",
			"getDeclaredFields", "getField", "getFields",
			"getDeclaredConstructors", "getConstructor", "getConstructors",
			"getDeclaredClasses", "getEnclosingMethod", "getEnclosingConstructor",
			"forName", "newInstance");
