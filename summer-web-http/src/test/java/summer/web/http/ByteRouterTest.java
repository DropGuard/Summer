...
public class ByteRouterTest {
	...
	void testStaticRouteMatching() {
		...
		HttpContext ctx = createMockContext("GET", "/api/users");
	...
	void testPathParameterMatching() {
		...
		HttpContext ctx = createMockContext("GET", "/users/42");
	...
	private HttpContext createMockContext(String method, String path) {
