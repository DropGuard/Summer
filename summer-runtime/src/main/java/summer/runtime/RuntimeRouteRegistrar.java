...
public class RuntimeRouteRegistrar implements RouteRegistrar {
    ...
    private static final Map<DotName, HttpMethod> HTTP_METHODS = Map.of(
            DotName.createSimple(Get.class), HttpMethod.GET,
            DotName.createSimple(Post.class), HttpMethod.POST,
            DotName.createSimple(Put.class), HttpMethod.PUT,
    ...
    public void registerControllers(HttpRouter.Builder builder, BeanContainer context) {
        ...
        // (e.g. inner-class test controllers registered via builder().registerComponent())
        if (context instanceof BeanContainer bc) {
            for (Class<?> clazz : bc.componentTypes()) {
    ...
    private void register(HttpRouter.Builder builder, BeanContainer context,
            AnnotationInstance ann, MethodInfo method, ClassInfo controllerClass, HttpMethod httpMethod) {
    ...
    private void registerFromReflection(HttpRouter.Builder builder, Object controller,
