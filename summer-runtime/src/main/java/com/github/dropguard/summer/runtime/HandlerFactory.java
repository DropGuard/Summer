		...
		return ctx -> {
			...
			try {
				...
				throw (cause instanceof RuntimeException re)
						? re
						: new com.github.dropguard.summer.aop.SummerAopException("Handler invocation failed", cause);
			} catch (IllegalAccessException e) {
				throw new com.github.dropguard.summer.aop.SummerAopException("Cannot access handler method", e);
			}
		};
	}
