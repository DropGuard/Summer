...
/**
 * Pre-computed exception handler metadata, registered as a synthetic bean during
 * container build so {@link RuntimeExceptionHandlerRegistrar} can receive it via
