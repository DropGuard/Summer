 ...
 *
 * <p>The runtime engine discovers handlers reflectively, so it builds the reflection-free {@link
 * HandlerParam} descriptor from a {@code Parameter} at registration time. This is the single place
 * where parameter reflection is translated into the shared, engine-agnostic descriptor consumed by
 * {@link com.github.dropguard.summer.web.HttpParameterResolver}.
 */
