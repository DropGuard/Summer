...
public final class RuntimeBeanAdapter {
	...
	public BeanDefinition adaptFactoryMethod(Method method) {
		...
		com.github.dropguard.summer.core.annotation.ConditionalOnBean methodConditional = method
				.getAnnotation(com.github.dropguard.summer.core.annotation.ConditionalOnBean.class);
	...
	private void collectAopBindings(Class<?> clazz, BeanDefinition bean) {
		...
		for (Annotation ann : clazz.getAnnotations()) {
			if (ann.annotationType().isAnnotationPresent(com.github.dropguard.summer.aop.InterceptorBinding.class)) {
		...
		for (Method method : clazz.getMethods()) {
			for (Annotation ann : method.getAnnotations()) {
				if (ann.annotationType()
						.isAnnotationPresent(com.github.dropguard.summer.aop.InterceptorBinding.class)) {
					bindings.add(ann.annotationType().getName());
				}
			}
		}
		...
		bean.isInterceptor = clazz.isAnnotationPresent(com.github.dropguard.summer.aop.Interceptor.class);
	...
	private void collectRoutes(Class<?> clazz, BeanDefinition bean) {
		...
		if (!clazz.isAnnotationPresent(com.github.dropguard.summer.web.annotation.RestController.class)) {
			return;
		}

		com.github.dropguard.summer.web.annotation.RestController restController = clazz
				.getAnnotation(com.github.dropguard.summer.web.annotation.RestController.class);
	...
	private String extractMethodPath(Method method) {
		if (method.isAnnotationPresent(com.github.dropguard.summer.web.annotation.Get.class)) {
			return method.getAnnotation(com.github.dropguard.summer.web.annotation.Get.class).value();
		}
		if (method.isAnnotationPresent(com.github.dropguard.summer.web.annotation.Post.class)) {
			return method.getAnnotation(com.github.dropguard.summer.web.annotation.Post.class).value();
		}
		if (method.isAnnotationPresent(com.github.dropguard.summer.web.annotation.Put.class)) {
			return method.getAnnotation(com.github.dropguard.summer.web.annotation.Put.class).value();
		}
		if (method.isAnnotationPresent(com.github.dropguard.summer.web.annotation.Delete.class)) {
			return method.getAnnotation(com.github.dropguard.summer.web.annotation.Delete.class).value();
		}
		return "";
	}
	...
	private void collectParameters(Method method, RouteInfo route) {
		for (int i = 0; i < method.getParameterCount(); i++) {
			...
			if (method.getParameters()[i]
					.isAnnotationPresent(com.github.dropguard.summer.web.annotation.PathParam.class)) {
				com.github.dropguard.summer.web.annotation.PathParam pathParam = method.getParameters()[i]
						.getAnnotation(com.github.dropguard.summer.web.annotation.PathParam.class);
			...
			} else if (method.getParameters()[i]
					.isAnnotationPresent(com.github.dropguard.summer.web.annotation.QueryParam.class)) {
				com.github.dropguard.summer.web.annotation.QueryParam queryParam = method.getParameters()[i]
						.getAnnotation(com.github.dropguard.summer.web.annotation.QueryParam.class);
				String bindingName = queryParam.value().isEmpty() ? paramName : queryParam.value();
				boolean validated = method.getParameters()[i].isAnnotationPresent(jakarta.validation.Valid.class);
				route.params.add(new RouteInfo.ParamInfo(paramName, bindingName, paramType.getName(),
						RouteInfo.ParamBinding.QUERY, validated));
			} else if (com.github.dropguard.summer.web.ScrollRequest.class.isAssignableFrom(paramType)) {
	...
	private void collectExceptionHandlers(Class<?> clazz, BeanDefinition bean) {
		for (Method method : clazz.getMethods()) {
			com.github.dropguard.summer.web.annotation.ExceptionHandler ann = method
					.getAnnotation(com.github.dropguard.summer.web.annotation.ExceptionHandler.class);
			if (ann != null) {
	...
	private void collectConditions(Class<?> clazz, BeanDefinition bean) {
		com.github.dropguard.summer.core.annotation.ConditionalOnBean cond = clazz
				.getAnnotation(com.github.dropguard.summer.core.annotation.ConditionalOnBean.class);
		if (cond != null) {
