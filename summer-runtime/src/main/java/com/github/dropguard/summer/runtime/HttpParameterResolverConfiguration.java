 ...
 *
 * <p>Only active when the runtime DI engine is in use (i.e., {@link RuntimeDiMarker} is present).
 * In AOT mode, parameter binding is generated inline by {@code RouteAdapterGenerator}.
 */
@Configuration
