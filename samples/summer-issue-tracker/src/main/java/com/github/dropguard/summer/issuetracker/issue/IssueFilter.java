...
/**
 * Filter criteria for {@link IssueRepository#search}. All fields nullable — {@code null} means "no
 * constraint on this dimension". This is the structured input behind the UI's dynamic issue board
 * filter.
 */
public record IssueFilter(
    ...
    public static class Builder {
        ...
        public Builder assigneeId(Long v) {
            this.assigneeId = v;
            return this;
        }
        ...
        public Builder reporterId(Long v) {
            this.reporterId = v;
            return this;
        }
