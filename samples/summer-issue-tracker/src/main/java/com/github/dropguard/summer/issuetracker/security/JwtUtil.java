...
/**
 * Thin JWT helper. Not part of the framework — the demo owns auth, the framework only provides the
 * HTTP plumbing and the DI container that wires this bean.
 */
@Component
public class JwtUtil {
    ...
    public JwtUtil(JwtProperties jwtProperties) {
        ...
        this.expirationMs =
                jwtProperties.expirationMs() > 0 ? jwtProperties.expirationMs() : 86400000L;
    }
