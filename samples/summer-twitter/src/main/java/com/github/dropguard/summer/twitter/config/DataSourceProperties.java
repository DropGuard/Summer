 ...
 * generates a strong-typed {@code $$ConfigImpl} in a separate package) and the runtime engine
 * (which proxies the interface) can access it — the {@code @ConfigMapping} contract requires it.
 */
