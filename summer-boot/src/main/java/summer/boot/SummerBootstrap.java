 ...
 *
 * <p>
 * The AOT build plugin generates an implementation of this interface at compile
 * time. {@code SummerApplication} discovers it via {@code Class.forName} and
 * calls {@link #launch()} to obtain a fully-wired {@link BeanContainer}.
 * </p>
 */
@FunctionalInterface
