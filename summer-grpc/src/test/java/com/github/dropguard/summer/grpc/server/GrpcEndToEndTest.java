...
/**
 * Canonical end-to-end test: a real gRPC client calls a service running on
 * the Summer-managed server.  Proves the full pipeline — server start,
 * interceptor, handler, response — works in one place.
 */
@SummerTest
    ...
    void unaryCallReturnsInterceptedResponse() throws Exception {
        ...
        io.grpc.stub.ClientCalls.asyncUnaryCall(
                ...
                new StreamObserver<String>() {
                    @Override public void onNext(String value) { received[0] = value; }
