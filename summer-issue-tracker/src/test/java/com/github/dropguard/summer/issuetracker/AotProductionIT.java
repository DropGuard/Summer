...
import com.github.dropguard.summer.issuetracker.security.AuthService;
...
public class AotProductionIT {
    ...
    void aotProductionContainerResolvesExternalDemoGraph() {
        ...
        var userRepo = context.getBean(com.github.dropguard.summer.issuetracker.user.UserRepository.class);
        var projectRepo = context.getBean(com.github.dropguard.summer.issuetracker.project.ProjectRepository.class);
        var idGen = context.getBean(com.github.dropguard.summer.issuetracker.common.IdGenerator.class);
        var user = userRepo.findById(result.userId()).orElseThrow();
        long projectId = idGen.nextId();
        projectRepo.insert(new com.github.dropguard.summer.issuetracker.project.Project(projectId, user.orgId(),
