...
import summer.issuetracker.security.RequireRole;
import summer.issuetracker.security.ResourceScope;
 ...
 * summer.issuetracker.security.RbacInterceptor} (for the coarse-grained gate)
 * from {@link summer.web.RequestContextHolder} — published by the framework's
