...
public class ReplacesBehaviorTest {
	...
	void testConditionalReplacesConditionUnmet() {
		assertThrows(Exception.class, () -> context.getBean(
				com.github.dropguard.summer.fixtures.di.replaces.conditional.ReplacesWithConditionComponent.class));

		com.github.dropguard.summer.fixtures.di.replaces.conditional.OriginalComponent original = context
				.getBean(com.github.dropguard.summer.fixtures.di.replaces.conditional.OriginalComponent.class);
