 ...
 * </p>
 * <ul>
 * <li>Route-level middleware via
 * {@link com.github.dropguard.summer.web.RouteProvider} applies correctly</li>
...
public abstract class AbstractMiddlewareTCK extends AbstractTCK {
	...
	void setUpRouter() {
		...
		for (com.github.dropguard.summer.web.RouteRegistrar registrar : ctx
				.getBeans(com.github.dropguard.summer.web.RouteRegistrar.class)) {
			registrar.registerControllers(builder, ctx);
		}

		com.github.dropguard.summer.fixtures.web.dummy.MyMiddleware myMiddleware = ctx
				.getBean(com.github.dropguard.summer.fixtures.web.dummy.MyMiddleware.class);
		com.github.dropguard.summer.fixtures.web.dummy.LoggingMiddleware loggingMiddleware = ctx
				.getBean(com.github.dropguard.summer.fixtures.web.dummy.LoggingMiddleware.class);
		...
		for (com.github.dropguard.summer.web.Middleware m : ctx
				.getBeans(com.github.dropguard.summer.web.Middleware.class)) {
			if (m.getClass().isAnnotationPresent(com.github.dropguard.summer.web.annotation.GlobalMiddleware.class)) {
	...
	private String routeWithMiddlewares(Request req) {
		...
		com.github.dropguard.summer.web.Handler handler = c -> {
			try {
				router.route(c);
			} catch (Exception e) {
				c.error(e);
