...
public class AopBehaviorTest {
	...
	void testBeanIsProxy() {
		Greeter greeter = context.getBean(Greeter.class);
		assertNotEquals(com.github.dropguard.summer.fixtures.aop.GreeterService.class, greeter.getClass(),
	...
	void testConcreteClassBypassesAop() {
		...
		com.github.dropguard.summer.fixtures.aop.GreeterService raw = context
				.getBean(com.github.dropguard.summer.fixtures.aop.GreeterService.class);
		assertEquals(com.github.dropguard.summer.fixtures.aop.GreeterService.class, raw.getClass(),
