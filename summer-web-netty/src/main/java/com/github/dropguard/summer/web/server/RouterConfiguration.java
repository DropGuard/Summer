 ...
 *
 * <p>Registers the built-in HTTP and WebSocket router implementations into the {@link
 * RouterRegistry}. This configuration is in summer-web-netty because it needs access to all router
 * implementations.
 *
 * <p>To replace a router implementation in tests, use {@code @Replaces} on a custom
