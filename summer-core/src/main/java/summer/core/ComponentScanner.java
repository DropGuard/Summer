...
/**
 * Component scanner for finding and registering Summer components.
 * Handles classpath scanning for @Component and @RestController annotated classes.
 */
            ...
            if (file.isDirectory()) {
                ...
                try {
                    ...
                    boolean isRestController = java.util.Arrays.stream(clazz.getAnnotations())
                            .anyMatch(a -> a.annotationType().getName().equals("summer.web.RestController"));
