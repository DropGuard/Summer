...
/**
 * Shared string-to-type conversion for configuration binding and parameter resolution. Supports
 * boxed types only (Integer, Long, Boolean, Double, String).
 */
public final class TypeConverter {
     ...
     *
     * @param value the string value to convert (null returns null)
     * @param targetType the target type (Integer, Long, Boolean, Double, or String)
     * @return the converted value, or null if value is null
     * @throws ConfigurationException if the type is unsupported
     */
