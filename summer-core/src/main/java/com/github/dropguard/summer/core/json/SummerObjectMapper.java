...
/**
 * Factory for creating pre-configured {@link ObjectMapper} instances with safe defaults.
 *
 * <p><strong>Security Design:</strong> Polymorphic deserialization is disabled to prevent Remote
 * Code Execution (RCE) attacks via Jackson gadget chains. Users must use explicit type conversion
 * with {@link ObjectMapper#convertValue}.
 *
...
public final class SummerObjectMapper {
     ...
     *
     * <ul>
     *   <li>JavaTimeModule registered
     *   <li>Unknown properties ignored
     *   <li>Polymorphic deserialization disabled
     * </ul>
     *
     ...
     *
     * @param customizer optional customizer to apply additional configuration
     * @return a new ObjectMapper with safe defaults
     */
    ...
    /**
     * Creates a YAML-aware ObjectMapper with safe settings and optional customization.
     *
     * @param customizer optional customizer to apply additional configuration
     * @return a new ObjectMapper configured for YAML parsing
     */
