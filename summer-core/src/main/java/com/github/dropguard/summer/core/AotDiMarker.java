 ...
 *
 * <p>
 * This is a framework infrastructure bean registered by the AOT-generated
 * {@code GeneratedAotContext} (or {@code AppBootstrap}) during the
 * {@code wire()} phase. It is NOT annotated with {@code @Component} because
 * framework code generates it programmatically.
 * </p>
 *
 * <p>
