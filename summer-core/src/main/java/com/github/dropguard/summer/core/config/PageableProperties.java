 ...
 *
 * <p>Bound from {@code application.yml} under the {@code com.github.dropguard.summer.pageable}
 * prefix.
 *
 * <p>Example YAML:
 *
...
public record PageableProperties(
        @DefaultValue("0") Integer defaultPage, @DefaultValue("20") Integer defaultSize) {}
