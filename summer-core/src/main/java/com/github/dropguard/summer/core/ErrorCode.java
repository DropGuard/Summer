...
/**
 * Structured error codes for the Summer framework. Each code uniquely
 * identifies an error condition, enabling programmatic error handling, i18n,
 * and client-side error mapping.
 */
public enum ErrorCode {
	// Beans (1xxx)
	BEAN_NOT_FOUND(1001, "No bean found for the requested type"), AMBIGUOUS_BEAN(1002,
			"Multiple beans match the requested type"), CIRCULAR_DEPENDENCY(1003,
					"Circular dependency detected between beans"), BEAN_CREATION_FAILED(1004,
							"Failed to create bean instance"), UNSUPPORTED_INJECTION(1005,
	...
	VALIDATION_FAILED(3001, "Request validation failed"), BODY_PARSE_ERROR(3002,
			"Failed to parse request body"), ROUTE_CONFLICT(3003,
					"Route registration conflict"), ARCHITECTURE_VIOLATION(3004, "Architecture constraint violated"),

	// Data (4xxx)
	DATA_ACCESS_ERROR(4001, "Database access error"), DATA_SERIALIZATION_ERROR(4002,
