...
public final class DiEngine {
	...
	private static final String AOT_CLASS = "com.github.dropguard.summer.core.aot.GeneratedAotContext";
	private static final String RUNTIME_CLASS = "com.github.dropguard.summer.runtime.RuntimeBeanContainerBuilder";
	...
	public static Engine detectEngine() {
		...
		String override = System.getProperty("com.github.dropguard.summer.engine", "").toLowerCase();
