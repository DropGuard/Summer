 ...
 *
 * <p>Verifies that polymorphic deserialization is disabled to prevent RCE attacks via Jackson
 * gadget chains (CVE-2017-7525, CVE-2019-12086, etc.).
 */
class SummerObjectMapperTest {
    ...
    class PolymorphicDeserializationTests {
        ...
        void noAutomaticTypeResolution() throws JsonProcessingException {
            ...
            assertInstanceOf(
                    Map.class, result, "Should deserialize to Map, not resolve type strings");
        }
    }
