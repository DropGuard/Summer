 ...
 *
 * <p>
 * Tests conversion logic, null handling, and error cases.
 * </p>
 */
class TypeConverterTest {
	...
	void shouldConvertLong() {
		...
		assertEquals(Long.MAX_VALUE, TypeConverter.convert(String.valueOf(Long.MAX_VALUE), Long.class));
	}
	...
	void shouldThrowForUnsupportedType() {
		assertThrows(ConfigurationException.class, () -> TypeConverter.convert("value", Float.class));
	}

	@Test
	void shouldThrowForInvalidInteger() {
		assertThrows(NumberFormatException.class, () -> TypeConverter.convert("abc", Integer.class));
	}
