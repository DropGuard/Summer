...
public final class Testing {
	...
	public static BeanContainer buildForTest(Class<?> testClass, Engine engine, List<MockedBean> mocks,
		...
		if (seeds.length > 0) {
			...
			com.github.dropguard.summer.core.bean.BeanDeployment moduleIndex = com.github.dropguard.summer.core.bean.BeanDeployment
					.forNarrow(narrowIndex);
	...
	private static Class<?>[] summerTestSeeds(Class<?> testClass) {
		...
		com.github.dropguard.summer.test.annotation.SummerTest ann = testClass
				.getAnnotation(com.github.dropguard.summer.test.annotation.SummerTest.class);
	 ...
	 *            from the stack
	 */
	private static com.github.dropguard.summer.core.bean.BeanDeployment testUniverse(Class<?> testClass) {
		...
		return com.github.dropguard.summer.core.bean.BeanDeployment.forTestUniverse(prod.index(), classToArchive,
				archiveIndexes);
	}
	...
	private static BeanContainer buildAot(AotKey key, List<MockedBean> mocks, java.util.Map<String, Object> overrides) {
		try {
			...
			java.lang.reflect.Method buildAndCompile = aotEngine.getMethod("buildAndCompile",
					com.github.dropguard.summer.core.bean.BeanDeployment.class, String.class, String.class,
					MockedBean[].class, java.util.Map.class);
