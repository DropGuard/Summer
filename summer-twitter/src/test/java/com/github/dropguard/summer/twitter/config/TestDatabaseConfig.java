 ...
 * {@code com.github.dropguard.summer.test.datasource.url} system property; this config simply reads
 * that property and opens its own small pool. No {@code com.github.dropguard.summer.test.internal}
        ...
        if (url == null) {
            throw new IllegalStateException(
                    "Twitter tests require a real database. AbstractTwitterIT sets "
                            + "com.github.dropguard.summer.test.datasource.url to a real JDBC URL — start the test via "
